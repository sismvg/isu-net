...
#include <sul-serialize/xdr/xdr_convert.hpp>
#include <sul-serialize/xdr/xdr_fundamental_wrap.hpp>
...
{
	mymemcpy(buffer, value.get(), value_size);
	return value_size;
}
	...
	const_xdr_opaque& value, size_t value_size)
{
	...
	mymemcpy(ptr, buffer, value_size);
